...
if __name__ == "__main__":
    ...
    ref_dir = "Z:/TZS/dataset/HiSa_HiDa"
    hairstep_dir = "Z:/TZS/output/single-view-hair/hairstep/HiSa_HiDa_test"
    difflocks_dir = "Z:/TZS/output/difflocks/HiSa_HiDa"
    ours_dir = "Z:/TZS/output/single-view-hair/results/reconstruction/hairstep/HiSa_HiDa"
    output_dir = "Z:/TZS/output/difflocks/HiSa_HiDa/evaluation"
    ...
    for hair_name in os.listdir(ours_dir):
        ...
        difflocks_hair_path = os.path.join(difflocks_dir, "results", hair_name, "strands_hairstep.hair")
        ours_hair_path = os.path.join(ours_dir, hair_name, "results/full_modifier.hair")
        
        if not os.path.exists(ours_hair_path):
            continue
        ...
        config["head_path"] = "Z:/TZS/output/single-view-hair/hairstep/head_model_metahuman.obj"
        ...
        config["ref_depth_path"] = os.path.join(ref_dir, "dense_depth_pred", "depth_map", hair_name+".npy")
        ...
        # load hair
        init_strands = resample_strands_fast(load_hair(difflocks_hair_path), 32).to(device)
        result_strands = resample_strands_fast(load_hair(ours_hair_path), 32).to(device)
